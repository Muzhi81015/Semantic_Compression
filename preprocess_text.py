...
parser.add_argument('--input-data-dir', default='europarl', type=str)
parser.add_argument('--output-train-dir', default='data.pkl', type=str)
parser.add_argument('--output-test-dir', default='data.pkl', type=str)
...
def cutted_data(cleaned, MIN_LENGTH=1, MAX_LENGTH=30):
    cutted_lines = list()
    for line in cleaned:
